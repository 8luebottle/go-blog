...
func TestLogin(t *testing.T) {
	...
	samples := []struct {
		...
		{
			inputJSON:    `{"email": "test@gmail.com", "password: "PAdsgsgsg"}`,
			statusCode:   422,
			errorMessage: "Incorrect Password",
		},
		{
			inputJSON:    `{"email": "teeeeee@gmail.com", "password": "password"}`,
			statusCode:   422,
			errorMessage: "Incorrect Details",
		},
		{
			inputJSON:    `{"email": "nothing@gmail.com", "password": "password"}`,
			statusCode:   422,
		...
		{
			inputJSON:    `{"email": "nano@gmail.com", "password": ""}`,
			statusCode:   422,
